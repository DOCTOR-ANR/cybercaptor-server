...
public class MagicRemediationAction extends RemediationAction {

    public MagicRemediationAction( ) throws Exception {

    }

    private String remediationActionType = "MAGIC";

    @Override
    public String toString() {
        return "MagicRemediationAction [actionType=" + remediationActionType
    ...
    public void toXMLElement( Element actionElement, Element typeElement ) {
     	...
     	typeElement.setText("magic");
	            	
     	Element userElement = new Element("spell_to_cast");
     	actionElement.addContent(userElement);
     	userElement.setText("Reparationibus");
    }
    ...
    public SerializableDeployableRemediationAction makeSerializableDeployableRemediationAction(InformationSystemHost host) {
        ...
        String remediationAction = "Reparationibus";
