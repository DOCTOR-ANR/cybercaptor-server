...
public class NetworkInfraConfigRemediationAction extends RemediationAction {

    public NetworkInfraConfigRemediationAction( ) throws Exception {

    }

    private String remediationActionType = "NETWORK_INFRA_CONFIG";

    @Override
    public String toString() {
        return "NetworkInfraConfigRemediationAction [actionType=" + remediationActionType
    ...
    public void toXMLElement( Element actionElement, Element typeElement ) {
     	...
     	typeElement.setText("NetworkInfraConfig");
	            	
     	Element userElement = new Element("NetworkInfraElement");
